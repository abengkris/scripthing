...
describe('SettingsService', () => {
  ...
  it('should decrypt API keys when retrieving (internal use)', async () => {
    ...
    const settings = await settingsService.getSettings(mockPrisma, userId, { decryptKeys: true });
  ...
  it('should return masked API keys for public use', async () => {
    ...
    const settings = await settingsService.getSettings(mockPrisma, userId, { decryptKeys: false });
